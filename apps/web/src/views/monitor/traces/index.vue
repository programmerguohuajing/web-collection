...
<template>
  ...
  <el-card shadow="never" class="section panel">
    ...
    <el-table v-loading="loading" :data="traces" border @row-click="open">
      ...
      <el-table-column label="页面" min-width="260"><template #default="{ row }"><el-tooltip :content="row.url" placement="top"><span class="table-ellipsis">{{ row.url }}</span></el-tooltip></template></el-table-column>
    </el-table>
