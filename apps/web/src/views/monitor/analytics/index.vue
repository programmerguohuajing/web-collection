  ...
  <el-tabs v-model="tab" v-loading="loading" class="panel section analytics-tabs" @tab-change="changeTab">
    ...
    <el-tab-pane label="用户会话" name="sessions">
      <el-table :data="sessions" border @row-click="openSession">
        ...
        <el-table-column prop="session_id" label="会话" min-width="200"><template #default="{ row }"><el-tooltip :content="row.session_id" placement="top"><span class="table-ellipsis">{{ row.session_id }}</span></el-tooltip></template></el-table-column>
