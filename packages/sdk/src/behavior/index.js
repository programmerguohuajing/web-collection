 ...
 */
export function setupBehaviorMonitor({ push, sanitizer, onRoute, onRotateClick, rotateSelectors, formTracking, rageClick, deadClick, interactionTracking, inputTracking, selectTracking }) {
  ...
  safeSetup('click', () => setupClickMonitor({ push, sanitizer, onRotateClick, rotateSelectors }))
